...
@DisplayName("Testes de integração do fluxo de loja")
class StoreFlowIntegrationTest extends IntegrationTestBase {

    @Test
    @DisplayName("Deve carregar estrutura base do fluxo de loja")
