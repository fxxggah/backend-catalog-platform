...
@DisplayName("Testes de integração do fluxo de produto")
class ProductFlowIntegrationTest extends IntegrationTestBase {

    @Test
    @DisplayName("Deve carregar estrutura base do fluxo de produto")
